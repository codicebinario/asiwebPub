...
Public Class upLegRinnovi
    ...
    Public Function QuantiAllegati(codR As String) As String
        ...
        fmsP.SetLayout("webRinnoviAllegati")
    ...
    Public Function CaricaSuFM(tokenx As String, id_att As String, nomecaricato As String) As Boolean
        ...
        Dim clientUP As New RestClient("https://93.63.195.98/fmi/data/vLatest/databases/Asi/layouts/webRinnoviAllegati/records/" & id_att & "/containers/Ricevuta_Pagamento_ext/1")
        clientUP.Timeout = -1
    ...
    Public Function NuovaRichiestaAllegato(codR As String, nomecaricato As String) As String
        ...
        '  Dim ds As DataSet
        Dim risposta As String = ""
        fmsP1.SetLayout("webRinnoviRichiesta")
