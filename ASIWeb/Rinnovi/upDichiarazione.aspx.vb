...
Public Class upDichiarazione
    ...
    Public Function CaricaSuFM(tokenx As String, id As String, nomecaricato As String) As Boolean
        ...
        Dim clientUP As New RestClient("https://93.63.195.98/fmi/data/vLatest/databases/Asi/layouts/webRinnoviRichiesta/records/" & id & "/containers/DichiarazioneEA/1")
        clientUP.Timeout = -1
