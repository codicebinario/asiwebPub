...
Public Class scaricaZipEquiparazione
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim pdf As String
        Dim IdEquiparazione As String = deEnco.QueryStringDecode(Request.QueryString("codR"))
        ...
        url = "https://crm.asinazionale.it/fmi/xml/cnt/" & nomeFilePC & "?-db=Asi&-lay=webEquiparazioniMaster&-recid=" & record_ID & "&-field=ZipMaster(1)"

        pdf = FotoS(url, IdEquiparazione)
    ...
    Public Function FotoS(urlFoto As String, nominativo As String)
        ...
        Using stream As MemoryStream = New MemoryStream()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=" & nominativo & "_tessere.zip")
