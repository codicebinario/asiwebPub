...
Public Class scaricaDiplomaEqui2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        pdf = FotoS("https://crm.asinazionale.it/fmi/xml/cnt/ " & nominativo & "?-db=Asi&-lay=webEquiparazioniRichiestaMolti&-recid=" & record_ID & "&-field=DiplomaEquiparazione(1)", nominativo)
