<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AsiMasterPageEqui2.Master" CodeBehind="annullaEquiparazioneMotivo2.aspx.vb" Inherits="ASIWeb.annullaEquiparazioneMotivo2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="container">
    <h3 class="display-5">Annullamento Equiparazione</h3>
    ...
    <br /><br />
      ...
      <div class="col-sm-12">
          <div class="row">
              <div class="col-sm-12">
                  <div class="form-group">
                      <h5>Annullamento Equiparazione</h5>
                      <hr />
                  </div>
              </div>
