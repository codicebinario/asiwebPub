...
Public Class scaricaDiplomaEquiparazioneN2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        url = "https://crm.asinazionale.it/fmi/xml/cnt/ " & nomeFilePC & "?-db=Asi&-lay=webEquiparazioniRichiestaMolti&-recid=" & record_ID & "&-field=DiplomaAsi(1)"
    ...
    Public Function FotoS(urlFoto As String, nominativo As String)
        ...
        Using stream As MemoryStream = New MemoryStream()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=" & record_ID & "_" & nominativo & "_diploma.pdf")
