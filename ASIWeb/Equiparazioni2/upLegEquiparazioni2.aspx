<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AsiMasterPageEqui2.Master" CodeBehind="upLegEquiparazioni2.aspx.vb" Inherits="ASIWeb.upLegEquiparazioni2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="container">
    <h3 class="display-5">Invio del documento pagamento Equiparazione</h3>
  ...
  <%--<asp:Literal ID="litDenominazioneJumbo" runat="server"></asp:Literal>--%>
        ...
        <p>
              ...
              <asp:LinkButton class="btn btn-success btn-sm btn-due" ID="lnkDashboard" CausesValidation="false" runat="server">Equiparazioni Attive</asp:LinkButton>
      ...
      <div class="col-sm-12">
          <div class="row">
              <div class="col-sm-12">
                  <div class="form-group">
                      <h5>Caricamento Documento Equiparazione</h5>
                                        <hr />
