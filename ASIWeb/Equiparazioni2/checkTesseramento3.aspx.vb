...
Public Class checkTesseramento3
    ...
    Public Function CaricaDatiDocumentoEquiparazione(codR As String,
        ...
        Catch ex As Exception
            AsiModel.LogIn.LogErrori(ex, "checkTesseramento3", "equiparazioni")
            Response.Redirect("../FriendlyMessage.aspx", False)
        End Try
        ...
        If Page.IsValid Then
            ...
            If Not String.IsNullOrEmpty(codR) Then
                ...
                If risultatoCheck = 1 Then
                    ...
                    '   Response.Write("ok")
                    Session("procedi") = "OK"
                    Session("codiceFiscale") = ""

                    Dim record_ID As String = ""


                    record_ID = CaricaDatiDocumentoEquiparazione(codR,
                    ...
                    Response.Redirect("richiestaEquiparazione2.aspx?codR=" & deEnco.QueryStringEncode(codR) & "&record_ID=" & deEnco.QueryStringEncode(record_ID) & "&cf=" & deEnco.QueryStringEncode("nd"))
