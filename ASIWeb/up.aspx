<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="up.aspx.vb" Inherits="ASIWeb.up1" %>
...
<div class="col-sm-12 mb-3 mb-md-0">
  ...
  <div class="container">
    <h3 class="display-5">Drag and Drop caricamento immagini</h3>
    <p class="lead">
    <p class="lead">Funziona con Chrome, Firefox 3.6+, IE10+, e Opera 12+</p>
  ...
  <div id="dropSection" >
    <%-- <h3><span class="badge badge-primary">Drag and Drop</span></h3>--%>
        <span class="message">Drag and Drop images file per caricarli!.
            <br />
            <i>(saranno visibili solo a te)</i></span>
    </div>
   <%-- <br />--%>
 <%--   File Caricati:--%>
    <hr />
        ...
        $(function () {
            ...
            $("#dropSection").filedrop({
                ...
                //    alert("response " + response);
                    ...
                    $('#uploadedFiles').append('file caricato: ' + response + '<br />')
