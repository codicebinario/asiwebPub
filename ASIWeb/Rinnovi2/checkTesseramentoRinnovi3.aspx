<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AsiMasterPageEqui2.Master" CodeBehind="checkTesseramentoRinnovi3.aspx.vb" Inherits="ASIWeb.checkTesseramentoRinnovi3" %>
      ...
      <div class="col-sm-12">
	                ...
	                <div class="col-sm-12">
						<div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label for="txtNome">Tess.Tecnico[*] </label>
                                    <asp:TextBox ID="txtTesserinoTecnico" CssClass="form-control" runat="server" MaxLength="250"></asp:TextBox>
                                </div>
                            </div>
                        </div>          
                    </div>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                        CssClass="errore" ErrorMessage="Numero tessera ASI" ControlToValidate="txtNumeroTessera"
                                        EnableClientScript="true"></asp:RequiredFieldValidator>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                        CssClass="errore" ErrorMessage="Tesserino Tecnico" ControlToValidate="txtTesserinoTecnico"
                                        EnableClientScript="true"></asp:RequiredFieldValidator>
