...
Public Class scaricaZipRinnovo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        url = "https://crm.asinazionale.it/fmi/xml/cnt/" & nomeFilePC & "?-db=Asi&-lay=webRinnoviMaster&-recid=" & record_ID & "&-field=ZipMaster(1)"

        pdf = FotoS(url, IdRinnovo)
