...
Public Class vediDocumentazione
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            caricaDiplomaFoto(IDEquiparazione)
    ...
    Sub caricaDiplomaFoto(IDEquiparazione As String)
        ...
        RequestP.AddSearchField("IDEquiparazione", IDEquiparazione, Enumerations.SearchOption.equals)
        ...
        If Not IsNothing(ds) AndAlso ds.Tables("main").Rows.Count > 0 Then
            ...
            For Each dr In ds.Tables("main").Rows
                ...
                recordid = Data.FixNull(dr("Id_record"))
