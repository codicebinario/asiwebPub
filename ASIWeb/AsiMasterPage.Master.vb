...
Public Class AsiMasterPage
    ...
    Sub NuovaRichiesta()
        ...
        Request.AddField("ente_codice", Session("codice"))
        Request.AddField("Status_ID", "0")
        ...
        RequestP.AddSearchField("Record_ID", Session("id_richiesta"), Enumerations.SearchOption.equals)
        ...
        If Not IsNothing(ds) AndAlso ds.Tables("main").Rows.Count > 0 Then
            ...
            AsiModel.LogIn.LogCambioStatus(Session("Codice_Richiesta"), "0", Session("WebUserEnte"))
