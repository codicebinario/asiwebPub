<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AsiMasterPageAlbo.Master" CodeBehind="upLegCorsi.aspx.vb" Inherits="ASIWeb.upLegCorsi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="container">
    <h6 class="fs-5 text-white text-decoration-none">Invio del documento pagamento Corso</h6>
