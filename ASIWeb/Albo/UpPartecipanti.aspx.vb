...
Public Class UpPartecipanti
    ...
    Public Function CaricaSuFM(tokenx As String, id As String, nomecaricato As String) As Boolean
        ...
        Dim filePath As String = Server.MapPath(ResolveUrl("~/elencoPartecipantiCorsi/"))
        ...
        Dim clientUP As New RestClient("https://93.63.195.98/fmi/data/vLatest/databases/Asi/layouts/webCorsiRichiesta/records/" & id & "/containers/ElencoPartecipanti/1")
        clientUP.Timeout = -1
        ...
        Requestx.AddParameter("upload", Server.MapPath(ResolveUrl("~/elencoPartecipantiCorsi/")) & nomecaricato & "")
