...
Public Class scaricaZipCorsi
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim pdf As String
        idCorso = deEnco.QueryStringDecode(Request.QueryString("codR"))
        ...
        url = "https://crm.asinazionale.it/fmi/xml/cnt/" & nomeFilePC & "?-db=Asi&-lay=webCorsiRichiesta&-recid=" & record_ID & "&-field=ZipMaster(1)"

        pdf = FotoS(url, idCorso)
    ...
    Public Function FotoS(urlFoto As String, nominativo As String)
        ...
        Using stream As MemoryStream = New MemoryStream()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=" & nominativo & "_tessere_diplomi.zip")
