<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AsiMasterPageAlbo.Master" CodeBehind="UpPartecipanti.aspx.vb" Inherits="ASIWeb.UpPartecipanti" %>
    ...
    <asp:Panel ID="pnlFase1" runat="server">
       ...
       <div class="col-sm-12">
          <div class="row">
              <div class="col-sm-12">
                  <div class="form-group">
                      <label for="z" class="titoletto">Caricamento Elenco Partecipanti [formato Excel XSLX]</label>
