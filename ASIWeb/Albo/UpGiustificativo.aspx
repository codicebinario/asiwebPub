<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AsiMasterPageAlbo.Master" CodeBehind="UpGiustificativo.aspx.vb" Inherits="ASIWeb.UpGiustificativo" %>
    ...
    <asp:Panel ID="pnlFase1" runat="server">
       ...
       <div class="col-sm-12">
          <div class="row">
              <div class="col-sm-12">
                  <div class="form-group">
                      <label for="z" class="titoletto">Caricamento Documento Pagamento Corso [formato PDF, JPG, PNG]</label>
